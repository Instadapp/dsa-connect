...
export const MORPHO_REWARDS_A: AbiItem[] = [
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: 'address[]', name: 'poolTokenAddresses', type: 'address[]' },
      { indexed: false, internalType: 'bool', name: 'tradeForMorphoToken', type: 'bool' },
      { indexed: false, internalType: 'uint256', name: 'amountOfRewards', type: 'uint256' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256[]', name: 'claimedAmounts', type: 'uint256[]' }
    ],
    name: 'LogClaimedMorphoAaveV3',
    type: 'event'
  },
  {
    inputs: [],
  ...
  },
  {
    inputs: [],
    name: 'MORPHO_AAVE_V3',
    outputs: [{ internalType: 'contract IMorphoCoreV3', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function'
  },
  {
  ...
  },
  {
    inputs: [],
    name: 'MORPHO_REWARDS',
    outputs: [{ internalType: 'contract IMorphoRewardsDistributor', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function'
  },
  {
    inputs: [
      { internalType: 'address[]', name: '_poolTokenAddresses', type: 'address[]' },
      { internalType: 'bool', name: '_tradeForMorphoToken', type: 'bool' },
