    ...
    inputs: [
      {
        components: [
          ...
          { internalType: 'uint256', name: 'toVaultId', type: 'uint256' },
          {
            internalType: 'enum Helpers.Protocol',
            name: 'source',
            type: 'uint8',
          ...
          { internalType: 'uint256', name: 'debtFee', type: 'uint256' },
          { internalType: 'bool', name: 'isFrom', type: 'bool' },
          ...
          {
            internalType: 'uint256',
            name: 'paybackRateMode',
            type: 'uint256',
          },
        ],
        internalType: 'struct RefinanceResolver.RefinanceMakerData',
        name: 'data',
        type: 'tuple',
      },
    ],
